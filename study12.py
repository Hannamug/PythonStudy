...
# t = f.readlines() # 여러 줄은 한번에 읽어서 list 형태 출력
# print(type(t), t)
# f.close()
#
# f = open('c:/Temp/pro.txt', 'r')
# t = f.readline() # 한 번에 한 줄씩 읽음 '파이썬'
# print(type(t), t)
# t = f.readline() # 한 번에 한 줄씩 읽음 '자바'
# print(t)
# f.close()
#
# f = open('c:/Temp/pro.txt', 'r')
# tt = f.read() # 문서 전체 내용을 한번에 읽음 '파이썬\n자바'
# print(type(tt), tt)
# f.close()
...
## 파이썬, 자바, 스프링, html, Django 를 한 줄씩 파일에 저장 후
## 내용을 읽어서 한 줄씩 출력
## 파일명 = c:\\myfold\\test4.txt
# with open('c:/myfold/test4.txt', 'w') as f:
#     f.write('파이썬\n')
#     f.write('자바\n')
#     f.write('스프링\n')
#     f.write('html\n')
...
#     print('저장완료')
#
# with open('c:/myfold/test4.txt', 'r') as f:
#     while True:
#         t = f.readline()
#         if not t: break
#         print(t, end='')
...
# ['A', 'B', 'AB', 'O', 'AB', 'O', 'B', 'AB']
# {'A':1, 'B':2, 'AB':3, 'O':2}
# c:\Temp\blood.txt 저장 후 읽어서 출력
# import pickle
# f = open("c:\\Temp\\blood.txt", 'wb')
# data = {'A':1, 'B':2, 'AB':3, 'O':2}
# pickle.dump(data, f)
# f.close()
# print('저장완료')
#
